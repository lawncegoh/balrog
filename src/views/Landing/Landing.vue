<template>
  <div>
    <b-navbar toggleable="lg" type="light" :class="[$style['alternate-bg'], $style['navbar-bg']]">
      <div class="container">
        <b-navbar-brand to="/">
          <img src="pseudo_razer.jpg" width="20%" height="20%" class="d-inline-block align-top text-center" alt="">
        </b-navbar-brand>
    ...
    <div :class="[$style['alternate-bg'], $style['header-bg']]" class="py-5 text-center">
      <div class="container">
        <!-- <logo /> -->
        <h1 :class="$style.green" @click=routeHome()><strong>
          Acceleraze
        </strong></h1>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <p>
              ...
              technologies that are needed for your company to grow. They are grouped 
              into categories like <i>Why do you need to digitalise?</i>, <i>Operational Technologies
              Streamlining</i> and <i>Cloud Databases</i>.
            </p>
          </div>
          <div class="col-md-4">
            <h3><b>Step 2</b></h3>
            <p>
              ...
              that you are most interested in. Then, do a simple comparison based on
              industry metrics that we have compiled.
            </p>
          </div>
          <div class="col-md-4">
            <h3><b>Step 3</b></h3>
